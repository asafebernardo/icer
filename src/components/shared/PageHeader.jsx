    ...
    <section className="relative min-h-[220px] overflow-hidden border-b border-primary/10 bg-primary py-14 dark:border-white/10 dark:bg-brand-surface sm:min-h-[260px] sm:py-16 lg:min-h-[300px] lg:py-20">
      ...
      <div className="container-page relative z-10">
        ...
        >
          ...
          {description && (
            <p className="mx-auto mt-4 max-w-xl whitespace-pre-wrap text-balance rounded-xl bg-primary-foreground/[0.14] px-3 py-2.5 text-sm font-medium leading-snug text-primary-foreground shadow-sm backdrop-blur-sm dark:bg-white/[0.14] dark:text-white sm:px-4">
              {description}
            </p>
          )}
        </motion.div>
