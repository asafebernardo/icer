...
import { ExternalLink, Plus, Pencil, Trash2, FileText, Link2 } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="sm:hidden mb-4">
            <div className="flex items-center gap-2" aria-label="Materiais / Links Úteis">
              ...
              <span className="flex-1 min-h-[40px] rounded-2xl px-3 text-[13px] font-semibold inline-flex items-center justify-center gap-2 border border-border bg-background shadow text-foreground" aria-current="page">
